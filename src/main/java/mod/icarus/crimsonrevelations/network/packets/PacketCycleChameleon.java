...
public class PacketCycleChameleon implements IMessage, IMessageHandler<PacketCycleChameleon, IMessage> {
    @Override
    ...
    @Override
    public IMessage onMessage(PacketCycleChameleon message, MessageContext ctx) {
